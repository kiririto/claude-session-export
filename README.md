...
- **Smart file splitting** - Auto-splits large sessions to stay within Claude's 2000-line read limit
...
- **智能文件分割** - 自动分割大型会话以适配 Claude 的 2000 行读取限制
...
- **自動ファイル分割** - Claude の 2000 行読み取り制限に収まるよう大きなセッションを自動分割
...
ファイル名形式：`YYYY-MM-DD_最初のメッセージタイトル.md`
